...
//     qDebug() << "=== PostgreSQL Connection Test ===\n";

//     Q1Connection* conn = new Q1Connection(
//         Q1Driver::POSTGRE_SQL,
//         ReadEnv("Q1ORM_DB_HOST", "localhost"),
//         ReadEnv("Q1ORM_DB_NAME", "q1orm_example"),
//         ReadEnv("Q1ORM_DB_USER", "postgres"),
//         ReadEnv("Q1ORM_DB_PASSWORD", "123"),
//         ReadEnvInt("Q1ORM_DB_PORT", 5432)
//         );

//     ApplicationDbContext ctx(conn);
//     if (!ctx.Initialize())
//     {
//         qWarning() << "PostgreSQL initialization failed:" << conn->ErrorMessage();
//         return -1;
//     }

//     qDebug() << "Connected and initialized PostgreSQL successfully!\n";
